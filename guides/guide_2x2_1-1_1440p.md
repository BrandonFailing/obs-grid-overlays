...
|------|-----------------|--------------|
| Cell 1 | 280, 0 | 710 × 710 |
| Cell 2 | 1570, 0 | 710 × 710 |
| Cell 3 | 280, 730 | 710 × 710 |
| Cell 4 | 1570, 730 | 710 × 710 |
...
3. **Add Grid Overlay (Top)**
   - Add `grid_2x2_1-1_1440p.png` as Image source
